...
class Calendar extends React.Component {
  ...
  componentWillMount() {
    ...
    store_Calendar.monthIndex = moment()
  }
  ...
  changeMonth(e) {
    ...
    // Show previous month
    if (e === 'prev') {
      store_Calendar.monthIndex = store_Calendar.monthIndex.subtract(1, 'month')
      store_Calendar.searchText = store_Calendar.monthIndex.format('MM-YYYY')
    }
  }
      ...
      <div className="col-xs-12">
        <div className="x_panel">
          ...
          <div className="x_content">
            <small className="hint">Below are the data for each day individualy. You can edit the data for each day by pressing the "Edit" button on the right of each day. You can also edit many days together by pressing the "Mass Edit Dates" button. Stop Sales is indicated by the red line on the left of each day. Press the buttons to search through months</small>

            <br /><br />
            <div className="row">
              <div className="col-md-4 col-sm-4 col-xs-6">
                <Link to={'dashboard/calendar/' + propertyID +
                '/roomType/' + roomTypeID + '/massEdit'}
                type="button"
                className="btn btn-success left">
                Mass Edit Dates</Link>
              </div>
              <div className="xs-offset-2 col-md-4 col-sm-4 col-xs-6">
                <h4><span className="pointer"
