...
import store_Bookings                 from '../../../Stores/Store_bookings.js'
...
class ShowBookings extends React.Component {
  ...
  render(){
    ...
    this.bookings = bookingsFull.map((booking) => {
      return <Booking key = {booking.id} booking = {booking} store_Bookings = {store_Bookings} propertyID={propertyID}></Booking>
    })
